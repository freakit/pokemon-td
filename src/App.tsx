        ...
        <div style={styles.gameLayout}>
          ...
          <div style={styles.bottomPanel}>
            ...
            <div style={styles.extraButtons}>
              <button onClick={() => setShowPokedex(true)} style={styles.bottomBtn}>📖 도감</button>
              <button onClick={() => setShowAchievements(true)} style={styles.bottomBtn}>🏆 업적</button>
      ...
      {gameOver && (
        <div style={styles.gameOverOverlay}>
          <div style={styles.gameOverModal}>
            ...
            <button onClick={handleReset} style={styles.restartBtn}>다시 시작</button>
          </div>
        </div>
      )}
    </div>
...
const styles: Record<string, React.CSSProperties> = {
  ...
  bottomBtn: {
    ...
    color: '#4cafff',
    fontWeight: 'bold',
    boxShadow: '0 4px 15px rgba(76, 175, 255, 0.2), inset 0 1px 0 rgba(255,255,255,0.1)',
  ...
  gameOverModal: { 
    ...
    boxShadow: '0 25px 80px rgba(231, 76, 60, 0.4), 0 0 100px rgba(231, 76, 60, 0.2), inset 0 1px 0 rgba(255,255,255,0.1)',
  ...
  restartBtn: { 
    ...
    cursor: 'pointer',
    fontWeight: 'bold',
    boxShadow: '0 8px 32px rgba(46, 204, 113, 0.5), inset 0 1px 0 rgba(255,255,255,0.2)',
